      ...
      <div class="row ma-0">
        <div class="col-12 col-md-6 px-sm-16">
          ...
          <v-card outlined elevation="0" class="rounded-xl pa-5">
            <p class="title--text mb-0">توجه داشته باشید که برای ثبت نوبت درجا:</p>
            <p class="mb-0">
              <v-icon small>mdi-check</v-icon>
              دسترسی به GPS گوشی الزامییست.
            </p>
            <p class="mb-0">
              <v-icon small>mdi-check</v-icon>
              و همچنین کیف پول کاروان و کیف پـول نـوبت دهی باید
              موجودی کافی داشته باشند.
            </p>
          </v-card>
        </div>
        <div class="col-12 col-md-6 px-sm-16">
